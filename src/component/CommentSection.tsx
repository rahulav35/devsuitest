...
function CommentSection() {
  ...
  return (
    <div className="min-h-[300px] w-[100%] flex flex-col justify-start items-center  ">
      <div className="h-[1px] w-[63%] bg-[#2d2b2b]  ml-12 my-2"></div>
      <div className="h-[50px] w-[87%] flex justify-center items-center  ml-3">
        {" "}
        ...
        <div className="h-[50px] w-[90%] rounded-3xl  border-[2px] border-[#2d2b2b] bg-[#121212f8] flex items-center justify-between  ">
          ...
          <div className="h-[45px] w-[50px] flex items-center justify-evenly  ">
            <div className="h-[35px] w-[35px] rounded-full flex items-center justify-center bg-gradient-to-tr from-[#0057FF] to-[#14d4db]">
      ...
      <WriteComment comment={commenttext} />
